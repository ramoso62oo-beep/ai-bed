    ...
    <>
      ...
      <div style={{ minHeight:"100vh", display:"flex", alignItems:"center", justifyContent:"center", padding:"80px 20px 40px", position:"relative", zIndex:1 }}>
        <div style={{ background:"rgba(6,13,46,0.75)", backdropFilter:"blur(24px)", border:"1px solid rgba(10,26,92,0.6)", borderRadius:16, padding:"32px 28px", width:"100%", maxWidth:460 }}>
          ...
          {/* Google */}
          <button onClick={() => router.push("/dashboard")} style={{ width:"100%", padding:11, borderRadius:8, background:"rgba(255,255,255,0.04)", border:"1px solid rgba(74,111,165,0.3)", color:"var(--text)", fontSize:".76rem", fontWeight:500, cursor:"pointer", display:"flex", alignItems:"center", justifyContent:"center", gap:10, marginBottom:14 }}>
