...
const DICT: Record<string, Dict> = {
  fr: { dashboard:"Dashboard", mybots:"Mes bots", market:"Marché", swap:"Swap", connections:"Connexions", positions:"Positions", whales:"Whale Tracker", signals:"Signaux IA", account:"Compte", wallet:"Portefeuille", news:"Actualités", experts:"Experts", contact:"Contact", help:"Aide", settings:"Paramètres", logout:"Déconnexion", language:"Langue", active:"ACTIF", pause:"PAUSE" },
  en: { dashboard:"Dashboard", mybots:"My bots", market:"Market", swap:"Swap", connections:"Connections", positions:"Positions", whales:"Whale Tracker", signals:"AI Signals", account:"Account", wallet:"Wallet", news:"News", experts:"Experts", contact:"Contact", help:"Help", settings:"Settings", logout:"Log out", language:"Language", active:"ACTIVE", pause:"PAUSED" },
